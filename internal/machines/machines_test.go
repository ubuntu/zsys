...
func TestGetUserStateAndDependencies(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"Is snapshot linked via its clone to a system state": {def: "state_snapshot_with_userdata_05.yaml", user: "root", depsFor: "rpool/USERDATA/root_bcde@snap2", wantErr: true},
		...
		"List, with onlyUserStateSave, the snapshot linked and its clone": {def: "state_snapshot_with_userdata_05.yaml", user: "root", depsFor: "rpool/USERDATA/root_bcde@snaproot1", onlyUserStateSave: true,
			wantDeps: []string{"rpool/USERDATA/root_bcde@snaproot1", "rpool/USERDATA/root_fghi"}},
